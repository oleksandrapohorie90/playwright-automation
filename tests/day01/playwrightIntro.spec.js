...
//it is useful when we want to see the result of our test before it closes the browser,
// but it is not recommended to use it in real tests, because it can slow down the test execution and make it less reliable,
// instead we should use other methods like page.waitForSelector() or page.waitForNavigation() to wait for specific elements or navigation to happen.
